      ...
      <TooltipTrigger asChild>
        <a
          ...
          className={cn(
            ...
            "bg-gradient-to-br from-neon-yellow to-accent", // Using new neon-yellow
            "flex items-center justify-center",
            "transition-all duration-300 ease-in-out",
            "group",
            isHovered ? "scale-110 shadow-lg shadow-neon-yellow/50" : ""
          )}
        ...
        >
          ...
          {isHovered && (
            <span className="absolute inset-0 rounded-full bg-neon-yellow/50 animate-pulse-light"></span>
          )}
        </a>
      </TooltipTrigger>
